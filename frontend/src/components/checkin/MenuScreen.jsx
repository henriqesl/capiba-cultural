...
import { Camera, ScanLine, Info, Megaphone, CalendarPlus, DollarSign, MapPin } from 'lucide-react';

// 1. Recebe 'onSpots' (que vem do CheckInPage)
const MenuScreen = ({ onScan, onReport, onSuggest, onSpots }) => (
        ...
        <div className="w-full max-w-6xl px-4 py-8 md:py-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12 items-start">
                ...
                <section className="flex flex-col gap-6">
                    ...
                    {/* 🟡 ABA AMARELA (Onde Ir / Spots) */}
                    <button 
                        onClick={onSpots} // <--- CONECTADO CORRETAMENTE AQUI
                    ...
                    >
                        ...
                        <div className="relative z-10 flex flex-col md:flex-row md:items-center gap-4">
                            ...
                            <div>
                                <h3 className="text-lg font-bold text-gray-900">Onde posso ir?</h3>
                                <p className="text-yellow-600 font-semibold text-sm uppercase tracking-wide mb-1">Ver Locais Parceiros</p>
                                <p className="text-gray-500 text-sm">Descubra museus e centros culturais.</p>
                            </div>
                        </div>
                    </button>
                    ...
                    <button onClick={onReport} className="relative overflow-hidden bg-white p-6 rounded-3xl shadow-lg border border-gray-100 text-left transition-all hover:-translate-y-1 hover:shadow-xl group">
                        ...
                        <div className="relative z-10 flex flex-col md:flex-row md:items-center gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-gray-500 text-sm">Tire uma foto e avise a galera!</p>
                            </div>
                        </div>
                    </button>
                    ...
                    <button onClick={onSuggest} className="relative overflow-hidden bg-white p-6 rounded-3xl shadow-lg border border-gray-100 text-left transition-all hover:-translate-y-1 hover:shadow-xl group">
                        ...
                        <div className="relative z-10 flex flex-col md:flex-row md:items-center gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-gray-500 text-sm">Sabe de um evento? Mande para a agenda.</p>
                            </div>
                        </div>
                    </button>
