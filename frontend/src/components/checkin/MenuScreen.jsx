      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12 items-start">
        ...
        <section className="bg-white p-6 rounded-3xl shadow-xl border border-gray-100 flex flex-col h-full min-h-[400px]">
          ...
          >
            ...
            <p className="mt-6 text-gray-300 font-medium z-10">
              Toque para abrir o scanner
            </p>
          </div>
        </section>
          ...
          >
            ...
            <div className="relative z-10 flex flex-col md:flex-row md:items-center gap-4">
              ...
              <div>
                ...
                <p className="text-yellow-600 font-semibold text-sm uppercase tracking-wide mb-1">
                  Ver Locais Parceiros
                </p>
                <p className="text-gray-500 text-sm">
                  Descubra museus e centros culturais.
                </p>
              </div>
            </div>
          </button>
          ...
          >
            ...
            <div className="relative z-10 flex flex-col md:flex-row md:items-center gap-4">
              ...
              <div>
                ...
                <p className="text-gray-500 text-sm">
                  Tire uma foto e avise a galera!
                </p>
              </div>
            </div>
          </button>
          ...
          >
            ...
            <div className="relative z-10 flex flex-col md:flex-row md:items-center gap-4">
              ...
              <div>
                ...
                <p className="text-gray-500 text-sm">
                  Sabe de um evento? Mande para a agenda.
                </p>
              </div>
            </div>
          </button>
