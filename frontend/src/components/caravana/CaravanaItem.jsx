...
import { Icon } from '../user/UserShared'; // Reutilizando ícones existentes
import { ICONS } from '../../utils/icons';

export const CaravanaItem = ({ name, date, eventName, membersCount, isOwner, onClick }) => {
  return (
    <div 
      onClick={onClick}
    ...
    >
      {/* Ícone da Caravana (Circular) [cite: 26] */}
      ...
      <div className="ml-4 text-right shrink-0 flex flex-col items-end gap-1">
        ...
        {/* Tag de Destaque (Dourado Capiba)  */}
        {isOwner && (
