...
export const CaravanaItem = ({ 
    imageUrl, // 🟢 NOVO: Recebe a URL da imagem ou do placeholder
    name, 
    date, 
    eventName, 
    membersCount, 
...
    >
      {/* 🟢 SUBSTITUÍDO: Área da Imagem/Placeholder (Circular) */}
      <div className="w-12 h-12 rounded-full flex items-center justify-center shrink-0 overflow-hidden bg-gray-200 border border-gray-300">
        {imageUrl ? (
            ...
            // Fallback para o ícone BUS, caso a URL falhe por algum motivo
