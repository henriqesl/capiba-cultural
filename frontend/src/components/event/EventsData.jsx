const EventsData = [
  {
    ...
    description:
      "Uma noite incrível com as melhores bandas de rock nacional, celebrando os clássicos que marcaram gerações.",
  ...
  },
  {
    ...
    description:
      "Deixe-se levar pelos sons suaves do saxofone e da guitarra. Um evento ao ar livre.",
  ...
  },
  {
    ...
    description:
      "Uma viagem no tempo através de esculturas e pinturas clássicas.",
    needsRegistration: false,
    age: 0,
    price: "R$ 30,00",
  },
