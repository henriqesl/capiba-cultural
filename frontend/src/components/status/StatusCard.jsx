...
const StatusCard = ({
  ...
  const missionCardClasses = isMissionCompleted
    ? "bg-gray-200 shadow-none border-gray-300 opacity-80"
    : "bg-white shadow-md hover:shadow-lg border-blue-100";

  const progressFillColor = isMissionCompleted ? "bg-gray-400" : "bg-blue-600";
