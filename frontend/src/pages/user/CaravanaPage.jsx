        ...
        <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <button
              ...
              className="flex flex-col items-center justify-center p-4 bg-blue-50 text-blue-700 rounded-xl hover:bg-blue-100 border border-blue-100 transition-colors"
            >
            ...
            <button
              ...
              className="flex flex-col items-center justify-center p-4 bg-gray-50 text-gray-700 rounded-xl hover:bg-gray-100 border border-gray-200 transition-colors"
            >
            ...
            <div className="space-y-3">
              ...
              {caravanas.map((caravana) => {
                const isBrokenPath =
                  !caravana.imagemUrl ||
                  caravana.imagemUrl ===
                    "uploads/defaults/caravana_padrao.png" ||
                  caravana.imagemUrl === "uploads/caravana_padrao.png";

                const imageUrl = isBrokenPath
                  ? DefaultCaravanaImage
                  : `${BASE_URL_BACKEND}/${caravana.imagemUrl}`;
                ...
                return (
                  <CaravanaItem
                    ...
                    onClick={() =>
                      (window.location.hash = `#/perfil/caravana/detalhes/${caravana.id}`)
                    }
                  />
                );
              })}
