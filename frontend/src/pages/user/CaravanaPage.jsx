...
const BASE_URL_BACKEND = 'http://localhost:3000'; // Mantemos para imagens que vêm do upload
...
                            {caravanas.map((caravana) => {
                                // 🟢 LÓGICA DE PREFIXO E PLACEHOLDER AQUI:
                               const isBrokenPath = 
                                    !caravana.imagemUrl || 
                                    caravana.imagemUrl === "uploads/defaults/caravana_padrao.png" || // Caminho 1
                                    caravana.imagemUrl === "uploads/caravana_padrao.png"; // Caminho 2 (Se existir)

                                const imageUrl = isBrokenPath
                                    ? DefaultCaravanaImage // Usa o placeholder estático
                                    : `${BASE_URL_BACKEND}/${caravana.imagemUrl}`; // Prefixa a URL válida

                                return (
                                    <CaravanaItem
                                        key={caravana.id}
                                        // 🟢 PASSANDO A URL CALCULADA
                                        imageUrl={imageUrl} 
                                        name={caravana.nome}
