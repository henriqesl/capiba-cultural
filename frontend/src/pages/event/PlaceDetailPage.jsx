...
const PlaceDetailPage = ({ placeId, onBack }) => {
    ...
    if (loading) return (
        <div className="h-screen flex items-center justify-center font-black text-purple-600 uppercase italic tracking-tighter">
            Carregando...
        </div>
    );

    if (!placeData) return (
        <div className="p-10 text-center font-bold text-gray-400 font-sans">
        ...
        <div className="min-h-screen bg-gray-50 font-sans text-gray-900">
            ...
            <div className="relative h-[35vh] w-full bg-purple-700 flex items-center justify-center overflow-hidden">
                ...
                <button 
                    ...
                    className="absolute top-6 left-6 z-30 p-3 bg-white/20 backdrop-blur-md rounded-2xl text-white border border-white/30 hover:bg-white/40 transition-all"
                >
                    ...
                    <div className="flex justify-end mb-6">
                        <div className="flex items-center gap-2 bg-green-100 px-4 py-2 rounded-2xl border border-green-200">
                            ...
                            <span className="text-green-700 font-black text-xs">
                                +{placeData.moedasCapibasDestribuidas ?? 100} CAPIBAS
                            </span>
                        </div>
                    </div>
