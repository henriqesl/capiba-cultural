...
const EventPage = () => {
  ...
  const carouselData =
    featuredEvents.length > 0 ? featuredEvents : eventos.slice(0, 3);
                  ...
                  >
                    ...
                    >
                      <div className="w-full h-full rounded-full bg-white flex flex-col items-center justify-center border-[3px] border-white">
                        <span
                          className={`text-sm font-black tracking-wide ${isSelected ? "text-blue-600" : "text-gray-400"}`}
                        >
                          {m.label}
                        </span>
                      </div>
                    ...
                    <span
                      className={`text-xs font-medium ${isSelected ? "text-blue-600" : "text-gray-300"}`}
                    >
                      {m.year}
                    </span>
                  </div>
                    ...
                    {activeTab === "reminders" ? (
                      <>
                        ...
                        <p className="text-sm text-gray-400">
                          Explore a agenda e adicione eventos!
                        </p>
                      </>
                    ) : (
                      <p className="text-gray-500 text-lg">
              ...
              <div className="max-w-6xl mx-auto w-full h-[500px] bg-gray-200 rounded-3xl overflow-hidden shadow-lg">
                ...
                {EventMap ? (
                  ...
                  <p className="text-center p-10">
                    Componente de Mapa não encontrado.
                  </p>
                )}
              </div>
            )}
