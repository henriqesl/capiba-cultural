...
function parse(dateStr, formatStr, referenceDate, options) {
  ...
  const uniquePrioritySetters = setters
    ...
    .sort((a, b) => b - a)
    .filter((priority, index3, array) => array.indexOf(priority) === index3)
    .map((priority) =>
      setters
...
function findNonDisabledListIndex(listRef, _temp) {
  ...
  do {
    ...
    index3 >= 0 &&
    index3 <= listRef.current.length - 1 &&
    isListIndexDisabled(listRef, index3, disabledIndices)
  );
  return index3;
}
...
function FloatingList(props) {
  ...
  const [nodes, setNodes] = React3.useState(() => new Set());
    ...
    (node) => {
      ...
      if (index3 !== null) {
        ...
        if (labelsRef) {
          ...
          labelsRef.current[index3] = isLabelDefined
            ? label
  ...
  function handleKeyDown(event) {
    ...
    if (isGrid) {
      ...
      const minGridIndex = cellMap.findIndex(
        (index3) =>
          index3 != null &&
          !isListIndexDisabled(elementsRef, index3, disabledIndices),
      );
              ...
              disabledIndices: getGridCellIndices(
                [
                  ...((typeof disabledIndices !== "function"
                    ? disabledIndices
                    : null) ||
                    elementsRef.current.map((_, index3) =>
                      isListIndexDisabled(elementsRef, index3, disabledIndices)
                        ? index3
                        : void 0,
                    )),
...
function warn() {
  ...
  if (
    !((_devMessageSet = devMessageSet) != null && _devMessageSet.has(message2))
  ) {
    var _devMessageSet2;
...
function error() {
  ...
  if (
    !(
      (_devMessageSet3 = devMessageSet) != null && _devMessageSet3.has(message2)
    )
  ) {
    var _devMessageSet4;
...
function enableScrollLock() {
  ...
  const isIOS =
    /iP(hone|ad|od)|iOS/.test(platform2) ||
...
var useDetectClickOutside = function (onClickOutside, ignoreClass) {
  ...
  var handleClickOutside = (0, import_react3.useCallback)(
    function (event) {
      var _a2;
      var target =
        (event.composed &&
      ...
      if (ref.current && !ref.current.contains(target)) {
        if (
          ...
          (_a2 = onClickOutsideRef.current) === null || _a2 === void 0
            ? void 0
            : _a2.call(onClickOutsideRef, event);
        }
      }
    },
    [ignoreClass],
...
var ClickOutsideWrapper = function (_a2) {
  var children = _a2.children,
    onClickOutside = _a2.onClickOutside,
    className = _a2.className,
    containerRef = _a2.containerRef,
    style = _a2.style,
    ignoreClass = _a2.ignoreClass;
...
function isDayDisabled(day, _a2) {
  ...
  return (
    ...
    (excludeDateIntervals &&
      excludeDateIntervals.some(function (_a3) {
        var start = _a3.start,
          end = _a3.end;
    ...
    (includeDateIntervals &&
      !includeDateIntervals.some(function (_a3) {
        var start = _a3.start,
          end = _a3.end;
        return isWithinInterval(day, { start, end });
      })) ||
    ...
    (excludeDates &&
      excludeDates.some(function (excludeDate) {
        ...
        if (excludeDate instanceof Date) {
          ...
          return isSameDay2(
            day,
            (_a3 = excludeDate.date) !== null && _a3 !== void 0
              ? _a3
              : new Date(),
          );
        }
...
function isTimeInDisabledRange(time, _a2) {
  var minTime2 = _a2.minTime,
    maxTime2 = _a2.maxTime;
...
function getEffectiveMinDate(_a2) {
  var minDate = _a2.minDate,
    includeDates = _a2.includeDates;
...
var InputTime = (function (_super) {
  ...
  function InputTime2(props) {
    ...
    _this.onTimeChange = function (time) {
      ...
      (_b = (_a2 = _this.props).onChange) === null || _b === void 0
        ? void 0
        : _b.call(_a2, date);
    };
    _this.renderTimeInput = function () {
      ...
      var _a2 = _this.props,
        date = _a2.date,
        timeString = _a2.timeString,
        customTimeInput = _a2.customTimeInput;
      if (customTimeInput) {
      ...
      return import_react3.default.createElement("input", {
        ...
        onClick: function () {
          var _a3;
          (_a3 = _this.inputRef.current) === null || _a3 === void 0
            ? void 0
            : _a3.focus();
        },
        required: true,
...
var Day = (function (_super) {
  ...
  function Day2() {
    ...
    _this.handleOnKeyDown = function (event) {
      ...
      (_b = (_a2 = _this.props).handleOnKeyDown) === null || _b === void 0
        ? void 0
        : _b.call(_a2, event);
    };
    ...
    _this.isKeyboardSelected = function () {
      ...
      var isSelectedDate = _this.props.selectsMultiple
        ? (_a2 = _this.props.selectedDates) === null || _a2 === void 0
          ? void 0
          : _a2.some(function (date) {
    ...
    _this.getHighLightedClass = function () {
      var _a2 = _this.props,
        day = _a2.day,
        highlightDates = _a2.highlightDates;
      if (!highlightDates) {
        return false;
      }
    ...
    _this.getHolidaysClass = function () {
      ...
      if (holidays.has(dayStr)) {
        return [
          (_a2 = holidays.get(dayStr)) === null || _a2 === void 0
            ? void 0
            : _a2.className,
        ];
      }
    ...
    _this.isInSelectingRange = function () {
      ...
      var _b = _this.props,
        ...
        endDate = _b.endDate;
      var selectingDate =
        (_a2 = _this.props.selectingDate) !== null && _a2 !== void 0
          ? _a2
      ...
      if (
        selectsStart &&
        endDate &&
        (isBefore(selectingDate, endDate) || isEqual2(selectingDate, endDate))
      ) {
      ...
      if (
        ...
        (isAfter(selectingDate, startDate) ||
          isEqual2(selectingDate, startDate))
      ) {
    ...
    _this.isSelected = function () {
      ...
      if (_this.props.selectsMultiple) {
        return (_a2 = _this.props.selectedDates) === null || _a2 === void 0
          ? void 0
          : _a2.some(function (date) {
              return _this.isSameDayOrWeek(date);
            });
    ...
    _this.getAriaLabel = function () {
      var _a2 = _this.props,
        day = _a2.day,
        _b = _a2.ariaLabelPrefixWhenEnabled,
        ariaLabelPrefixWhenEnabled = _b === void 0 ? "Choose" : _b,
        _c = _a2.ariaLabelPrefixWhenDisabled,
      ...
      var tabIndex =
        ...
        (_this.isKeyboardSelected() ||
          (_this.isSameDay(selectedDay) &&
            isSameDay2(preSelectionDay, selectedDay)))
          ? 0
          : -1;
      return tabIndex;
    };
    _this.handleFocusDay = function () {
      ...
      _this.shouldFocusDay() &&
        ((_a2 = _this.dayEl.current) === null || _a2 === void 0
          ? void 0
          : _a2.focus({ preventScroll: true }));
    };
  ...
  Day2.prototype.isDayActiveElement = function () {
    ...
    return (
      ((_b =
        (_a2 = this.props.containerRef) === null || _a2 === void 0
          ? void 0
          : _a2.current) === null || _b === void 0
        ? void 0
...
var WeekNumber = (function (_super) {
  ...
  function WeekNumber2() {
    ...
    _this.isKeyboardSelected = function () {
      return (
        ...
        !isSameDay2(_this.props.date, _this.props.selected) &&
        isSameDay2(_this.props.date, _this.props.preSelection)
      );
    };
    _this.getTabIndex = function () {
      return _this.props.showWeekPicker &&
        ...
        (_this.isKeyboardSelected() ||
          (isSameDay2(_this.props.date, _this.props.selected) &&
            isSameDay2(_this.props.preSelection, _this.props.selected)))
        ? 0
        : -1;
    };
  ...
  WeekNumber2.prototype.render = function () {
    var _a2 = this.props,
      weekNumber = _a2.weekNumber,
      isWeekDisabled = _a2.isWeekDisabled,
      _b = _a2.ariaLabelPrefix,
      ariaLabelPrefix =
        _b === void 0 ? WeekNumber2.defaultProps.ariaLabelPrefix : _b,
      onClick = _a2.onClick;
    var weekNumberClasses = {
      "react-datepicker__week-number": true,
      "react-datepicker__week-number--clickable": !!onClick && !isWeekDisabled,
      "react-datepicker__week-number--selected":
        !!onClick && isSameDay2(this.props.date, this.props.selected),
    };
    return import_react3.default.createElement(
      "div",
      {
...
var Week = (function (_super) {
  ...
  function Week2() {
    ...
    _this.handleWeekClick = function (day, weekNumber, event) {
      ...
      if (
        (_a2 = _this.props.shouldCloseOnSelect) !== null && _a2 !== void 0
          ? _a2
          : Week2.defaultProps.shouldCloseOnSelect
      ) {
    ...
    _this.renderDays = function () {
      ...
      if (_this.props.showWeekNumber) {
        var onClickAction =
          _this.props.onWeekSelect || _this.props.showWeekPicker
            ? _this.handleWeekClick.bind(_this, startOfWeek2, weekNumber)
            : void 0;
        days.push(
          import_react3.default.createElement(
            WeekNumber,
            _assign({ key: "W" }, Week2.defaultProps, _this.props, {
              weekNumber,
      ...
      return days.concat(
        [0, 1, 2, 3, 4, 5, 6].map(function (offset4) {
          var day = addDays(startOfWeek2, offset4);
          return import_react3.default.createElement(
            Day,
            _assign({}, Week2.defaultProps, _this.props, {
    ...
    _this.isKeyboardSelected = function () {
      return (
        !_this.props.disabledKeyboardNavigation &&
        !isSameDay2(_this.startOfWeek(), _this.props.selected) &&
        isSameDay2(_this.startOfWeek(), _this.props.preSelection)
      );
    };
    return _this;
  }
  ...
  Week2.prototype.render = function () {
    var weekNumberClasses = {
      ...
      "react-datepicker__week--selected": isSameDay2(
        this.startOfWeek(),
        this.props.selected,
      ),
...
var Month = (function (_super) {
  ...
  function Month2() {
    ...
    _this.handleDayClick = function (day, event) {
      var _a2, _b;
      (_b = (_a2 = _this.props).onDayClick) === null || _b === void 0
        ? void 0
        : _b.call(_a2, day, event, _this.props.orderInDisplay);
    };
    _this.handleDayMouseEnter = function (day) {
      var _a2, _b;
      (_b = (_a2 = _this.props).onDayMouseEnter) === null || _b === void 0
        ? void 0
        : _b.call(_a2, day);
    };
    _this.handleMouseLeave = function () {
      var _a2, _b;
      (_b = (_a2 = _this.props).onMouseLeave) === null || _b === void 0
        ? void 0
        : _b.call(_a2);
    };
    ...
    _this.isMonthSelected = function () {
      var _a2 = _this.props,
        day = _a2.day,
        selected = _a2.selected,
        selectedDates = _a2.selectedDates,
        selectsMultiple = _a2.selectsMultiple;
    ...
    _this.onMonthClick = function (event, m) {
      var _a2 = _this.isMonthDisabledForLabelDate(m),
        isDisabled = _a2.isDisabled,
        labelDate = _a2.labelDate;
      if (isDisabled) {
        return;
      }
    ...
    _this.handleMonthNavigation = function (newMonth, newDate2) {
      var _a2, _b, _c, _d;
      (_b = (_a2 = _this.props).setPreSelection) === null || _b === void 0
        ? void 0
        : _b.call(_a2, newDate2);
      (_d =
    ...
    _this.handleKeyboardNavigation = function (event, eventKey, month) {
      ...
      var monthsGrid =
        (_a2 = MONTH_COLUMNS[monthColumnsLayout]) === null || _a2 === void 0
          ? void 0
          : _a2.grid;
      var calculateNewDateAndMonth = function (eventKey2, date, month2) {
        ...
        switch (eventKey2) {
          case KeyType.ArrowRight:
            newCalculatedDate2 = addMonths(
              date,
              MONTH_NAVIGATION_HORIZONTAL_OFFSET,
            );
            newCalculatedMonth2 =
              month2 === 11 ? 0 : month2 + MONTH_NAVIGATION_HORIZONTAL_OFFSET;
            break;
          case KeyType.ArrowLeft:
            newCalculatedDate2 = subMonths(
              date,
              MONTH_NAVIGATION_HORIZONTAL_OFFSET,
            );
            newCalculatedMonth2 =
              month2 === 0 ? 11 : month2 - MONTH_NAVIGATION_HORIZONTAL_OFFSET;
            break;
            ...
            newCalculatedMonth2 = (
              (_a3 =
                monthsGrid === null || monthsGrid === void 0
                  ? void 0
                  : monthsGrid[0]) === null || _a3 === void 0
                ? void 0
                : _a3.includes(month2)
            )
              ? month2 + 12 - verticalOffset
              : month2 - verticalOffset;
            break;
        ...
        return {
          newCalculatedDate: newCalculatedDate2,
          newCalculatedMonth: newCalculatedMonth2,
        };
      };
      var getNewDateAndMonth = function (eventKey2, selectedDate, month2) {
        ...
        var iterations = 0;
        var _a3 = calculateNewDateAndMonth(eventKeyCopy, selectedDate, month2),
          newCalculatedDate2 = _a3.newCalculatedDate,
          newCalculatedMonth2 = _a3.newCalculatedMonth;
    ...
    _this.getVerticalOffset = function (monthColumnsLayout) {
      ...
      return (_b =
        (_a2 = MONTH_COLUMNS[monthColumnsLayout]) === null || _a2 === void 0
          ? void 0
          : _a2.verticalNavigationOffset) !== null && _b !== void 0
        ? _b
        : 0;
    };
    _this.onMonthKeyDown = function (event, month) {
      var _a2 = _this.props,
        disabledKeyboardNavigation = _a2.disabledKeyboardNavigation,
        handleOnMonthKeyDown = _a2.handleOnMonthKeyDown;
      var eventKey = event.key;
      ...
      if (!_this.props.disabledKeyboardNavigation) {
        switch (eventKey) {
          case KeyType.Enter:
            ...
            (_b = (_a2 = _this.props).setPreSelection) === null || _b === void 0
              ? void 0
              : _b.call(_a2, _this.props.selected);
            break;
          case KeyType.ArrowRight:
      ...
      return {
        isDisabled:
          (_a2 =
            ...
            isMonthDisabled(labelDate, _this.props)) !== null && _a2 !== void 0
            ? _a2
            : false,
        labelDate,
      };
    ...
    _this.getMonthClassNames = function (m) {
      var _a2 = _this.props,
        ...
        startDate = _a2.startDate,
        endDate = _a2.endDate,
        preSelection = _a2.preSelection,
        monthClassName = _a2.monthClassName;
    ...
    _this.getAriaLabel = function (month) {
      var _a2 = _this.props,
        _b = _a2.chooseDayAriaLabelPrefix,
        chooseDayAriaLabelPrefix = _b === void 0 ? "Choose" : _b,
        _c = _a2.disabledDayAriaLabelPrefix,
    ...
    _this.getMonthContent = function (m) {
      var _a2 = _this.props,
        showFullMonthYearPicker = _a2.showFullMonthYearPicker,
        renderMonthContent = _a2.renderMonthContent,
        locale = _a2.locale,
        day = _a2.day;
    ...
    _this.getQuarterContent = function (q) {
      ...
      return (_a2 =
        renderQuarterContent === null || renderQuarterContent === void 0
          ? void 0
          : renderQuarterContent(q, shortQuarter)) !== null && _a2 !== void 0
        ? _a2
        : shortQuarter;
    };
    ...
    _this.getClassNames = function () {
      var _a2 = _this.props,
        selectingDate = _a2.selectingDate,
        selectsStart = _a2.selectsStart,
        selectsEnd = _a2.selectsEnd,
        showMonthYearPicker = _a2.showMonthYearPicker,
        showQuarterYearPicker = _a2.showQuarterYearPicker,
        showWeekPicker = _a2.showWeekPicker;
      return clsx(
      ...
      switch (e.key) {
        ...
        case "ArrowDown": {
          ...
          var newMonth =
            ...
            _this.props.monthNames.length;
          (_a2 = _this.monthOptionButtonsRef[newMonth]) === null ||
          _a2 === void 0
            ? void 0
            : _a2.focus();
          break;
  ...
  function MonthYearDropdownOptions2(props) {
    ...
    _this.renderOptions = function () {
      return _this.state.monthYearsList.map(function (monthYear) {
        ...
        var isSameMonthYear =
          isSameYear2(_this.props.date, monthYear) &&
          isSameMonth2(_this.props.date, monthYear);
        return import_react3.default.createElement(
          "div",
          {
...
var MonthYearDropdown = (function (_super) {
  ...
  function MonthYearDropdown2() {
    ...
    _this.onChange = function (monthYearPoint) {
      ...
      if (
        isSameYear2(_this.props.date, changedDate) &&
        isSameMonth2(_this.props.date, changedDate)
      ) {
        return;
      }
...
var Time = (function (_super) {
    ...
    _this.scrollToTheSelectedTime = function () {
      requestAnimationFrame(function () {
        ...
        _this.list.scrollTop =
          (_c =
            _this.centerLi &&
            Time2.calcCenterPosition(
              _this.props.monthRef
                ? _this.props.monthRef.clientHeight -
                    ((_b =
                      (_a2 = _this.header) === null || _a2 === void 0
                        ? void 0
                        : _a2.clientHeight) !== null && _b !== void 0
                      ? _b
                      : 0)
    ...
    _this.liClasses = function (time) {
      ...
      if (
        ...
        (getHours(time) * 3600 + getMinutes(time) * 60 + getSeconds(time)) %
          (((_a2 = _this.props.intervals) !== null && _a2 !== void 0
            ? _a2
            : Time2.defaultProps.intervals) *
            60) !==
          0
      ) {
  ...
  Time2.prototype.componentWillUnmount = function () {
    var _a2;
    (_a2 = this.resizeObserver) === null || _a2 === void 0
      ? void 0
      : _a2.disconnect();
  };
    ...
    return import_react3.default.createElement(
      "div",
      {
        className: "react-datepicker__time-container ".concat(
          (
            (_a2 = this.props.todayButton) !== null && _a2 !== void 0
              ? _a2
              : Time2.defaultProps.todayButton
          )
...
var Year = (function (_super) {
  ...
  function Year2(props) {
    ...
    _this.selectingDate = function () {
      var _a2;
      return (_a2 = _this.props.selectingDate) !== null && _a2 !== void 0
        ? _a2
        : _this.props.preSelection;
    };
    _this.updateFocusOnPaginate = function (refIndex) {
      var waitForReRender = function () {
        var _a2, _b;
        (_b =
          (_a2 = _this.YEAR_REFS[refIndex]) === null || _a2 === void 0
            ? void 0
            : _a2.current) === null || _b === void 0
          ? void 0
          : _b.focus();
    ...
    _this.isRangeStart = function (y) {
      return (
        ...
        _this.props.endDate &&
        isSameYear2(setYear(newDate(), y), _this.props.startDate)
      );
    };
    _this.isRangeEnd = function (y) {
      return (
        _this.props.startDate &&
        _this.props.endDate &&
        isSameYear2(setYear(newDate(), y), _this.props.endDate)
      );
    };
    ...
    _this.isSelectingRangeStart = function (y) {
      ...
      if (selectsStart) {
        return isSameYear2(
          _year,
          (_a2 = _this.selectingDate()) !== null && _a2 !== void 0 ? _a2 : null,
        );
      }
      return isSameYear2(
        _year,
    ...
    _this.isKeyboardSelected = function (y) {
      ...
      var isSelectedDay =
        !!selected && isSameDay2(date, getStartOfYear(selected));
      var isKeyboardSelectedDay = isSameDay2(
        date,
      ...
      if (!_this.props.disabledKeyboardNavigation) {
        switch (key) {
          ...
          case KeyType.ArrowUp: {
            ...
            _this.handleYearNavigation(
              newYear,
              subYears(_this.props.preSelection, offset4),
            );
            break;
          }
          case KeyType.ArrowDown: {
            ...
            _this.handleYearNavigation(
              newYear,
              addYears(_this.props.preSelection, offset4),
            );
            break;
          }
        }
    ...
    _this.getYearClassNames = function (y) {
      var _a2 = _this.props,
        ...
        includeDates = _a2.includeDates,
        filterDate = _a2.filterDate,
        yearClassName = _a2.yearClassName;
      return clsx(
  ...
  Year2.prototype.render = function () {
    ...
    var _a2 = this.props,
      date = _a2.date,
      yearItemNumber = _a2.yearItemNumber,
      onYearMouseEnter = _a2.onYearMouseEnter,
      onYearMouseLeave = _a2.onYearMouseLeave;
    if (date === void 0) {
      return null;
    }
    ...
    var _loop_1 = function (y2) {
      yearsList.push(
        import_react3.default.createElement(
          "div",
          {
            ref: this_1.YEAR_REFS[y2 - startPeriod],
            onClick: function (event) {
            ...
            tabIndex: Number(this_1.getYearTabIndex(y2)),
            className: this_1.getYearClassNames(y2),
            ...
            onPointerLeave: this_1.props.usePointerEvent
              ...
              : void 0,
            key: y2,
            "aria-current": this_1.isCurrentYear(y2) ? "date" : void 0,
          },
          this_1.getYearContent(y2),
        ),
      );
    };
    var this_1 = this;
      ...
      switch (e.key) {
        ...
        case "ArrowDown": {
          ...
          if (_this.yearOptionButtonsRef[newYear]) {
            (_a2 = _this.yearOptionButtonsRef[newYear]) === null ||
            _a2 === void 0
              ? void 0
              : _a2.focus();
          }
...
var YearDropdown = (function (_super) {
  ...
  function YearDropdown2() {
    ...
    _this.handleYearChange = function (date, event) {
      var _a2;
      (_a2 = _this.onSelect) === null || _a2 === void 0
        ? void 0
        : _a2.call(_this, date, event);
      _this.setOpen();
    };
    _this.onSelect = function (date, event) {
      var _a2, _b;
      (_b = (_a2 = _this.props).onSelect) === null || _b === void 0
        ? void 0
        : _b.call(_a2, date, event);
    };
    _this.setOpen = function () {
      var _a2, _b;
      (_b = (_a2 = _this.props).setOpen) === null || _b === void 0
        ? void 0
        : _b.call(_a2, true);
    };
    return _this;
...
var Calendar = (function (_super) {
  ...
  function Calendar2(props) {
    ...
    _this.handleDropdownFocus = function (event) {
      ...
      if (isDropdownSelect(event.target)) {
        (_b = (_a2 = _this.props).onDropdownFocus) === null || _b === void 0
          ? void 0
          : _b.call(_a2, event);
      }
    };
    ...
    _this.handleYearChange = function (date) {
      var _a2, _b, _c, _d;
      (_b = (_a2 = _this.props).onYearChange) === null || _b === void 0
        ? void 0
        : _b.call(_a2, date);
    ...
    _this.handleMonthChange = function (date) {
      ...
      var enabledPreSelectionDate =
        (_a2 = _this.getEnabledPreSelectionDateForMonth(date)) !== null &&
        _a2 !== void 0
          ? _a2
          : date;
    ...
    _this.handleCustomMonthChange = function (date) {
      var _a2, _b;
      (_b = (_a2 = _this.props).onMonthChange) === null || _b === void 0
        ? void 0
        : _b.call(_a2, date);
      _this.setState({ isRenderAriaLiveMessage: true });
    };
    ...
    _this.header = function (date) {
      ...
      var startOfWeek2 = getStartOfWeek(
        date,
        _this.props.locale,
        _this.props.calendarStartDay,
      );
            ...
            date: subYears(
              ...
              _this.props.showYearPicker
                ? (_b = _this.props.yearItemNumber) !== null && _b !== void 0
                  ? _b
                  : Calendar2.defaultProps.yearItemNumber
                : 1,
            ),
          };
        },
    ...
    _this.renderPreviousButton = function () {
      ...
      var monthsShown =
        (_a2 = _this.props.monthsShown) !== null && _a2 !== void 0
          ? _a2
          : Calendar2.defaultProps.monthsShown;
      ...
      if (
        (!((_c = _this.props.forceShowMonthNavigation) !== null && _c !== void 0
          ? _c
          : Calendar2.defaultProps.forceShowMonthNavigation) &&
      ...
      var _d = _this.props,
        ...
        previousMonthButtonLabel =
          _e === void 0 ? Calendar2.defaultProps.previousMonthButtonLabel : _e,
        _f = _d.previousYearButtonLabel,
        previousYearButtonLabel =
          _f === void 0 ? Calendar2.defaultProps.previousYearButtonLabel : _f;
      var _g = _this.props,
    ...
    _this.renderNextButton = function () {
      ...
      if (
        (!((_a2 = _this.props.forceShowMonthNavigation) !== null &&
        _a2 !== void 0
          ? _a2
          : Calendar2.defaultProps.forceShowMonthNavigation) &&
          !_this.props.showDisabledMonthNavigation &&
      ...
      var _b = _this.props,
        ...
        nextMonthButtonLabel =
          _c === void 0 ? Calendar2.defaultProps.nextMonthButtonLabel : _c,
        _d = _b.nextYearButtonLabel,
        nextYearButtonLabel =
          _d === void 0 ? Calendar2.defaultProps.nextYearButtonLabel : _d;
      var _e = _this.props,
    ...
    _this.renderYearDropdown = function (overrideHide) {
      ...
      return import_react3.default.createElement(
        YearDropdown,
        _assign({}, Calendar2.defaultProps, _this.props, {
          date: _this.state.date,
    ...
    _this.renderCustomHeader = function (headerArgs) {
      ...
      return import_react3.default.createElement(
        ...
        (_b = (_a2 = _this.props).renderCustomHeader) === null || _b === void 0
          ? void 0
          : _b.call(
              _a2,
              _assign(
    ...
    _this.renderYearHeader = function (_a2) {
      ...
      var _b = _this.props,
        ...
        _c = _b.yearItemNumber,
        yearItemNumber =
          _c === void 0 ? Calendar2.defaultProps.yearItemNumber : _c;
      var _d = getYearsPeriod(monthDate, yearItemNumber),
            ...
            "div",
            {
              ...
              ref: function (div) {
                _this.monthContainer =
                  div !== null && div !== void 0 ? div : void 0;
              },
    ...
    _this.renderAriaLiveRegion = function () {
      ...
      var _b = getYearsPeriod(
          _this.state.date,
          (_a2 = _this.props.yearItemNumber) !== null && _a2 !== void 0
            ? _a2
            : Calendar2.defaultProps.yearItemNumber,
        ),
        startPeriod = _b.startPeriod,
  ...
  Calendar2.prototype.componentDidUpdate = function (prevProps) {
    ...
    if (
      ...
      (!isSameDay2(this.props.preSelection, prevProps.preSelection) ||
        this.props.monthSelectedIn !== prevProps.monthSelectedIn)
    ) {
      var hasMonthChanged_1 = !isSameMonth2(
        this.state.date,
        this.props.preSelection,
      );
      this.setState(
      ...
      !isSameDay2(this.props.openToDate, prevProps.openToDate)
    ) {
      this.setState({
...
var TabLoop = (function (_super) {
  ...
  function TabLoop2(props) {
    ...
    _this.getTabChildren = function () {
      ...
      return Array.prototype.slice
        .call(
          (_a2 = _this.tabLoopRef.current) === null || _a2 === void 0
            ? void 0
            : _a2.querySelectorAll(focusableElementsSelector),
          1,
          -1,
        )
  ...
  TabLoop2.prototype.render = function () {
    var _a2;
    if (
      !((_a2 = this.props.enableTabLoop) !== null && _a2 !== void 0
        ? _a2
        : TabLoop2.defaultProps.enableTabLoop)
    ) {
...
function withFloating(Component2) {
  function WithFloating(props) {
    ...
    var floatingProps = useFloating2(
      _assign(
        {
          open: !hidePopper,
          ...
          middleware: __spreadArray(
            ...
            (_a2 = props.popperModifiers) !== null && _a2 !== void 0 ? _a2 : [],
            true,
          ),
        },
        props.popperProps,
...
var PopperComponent = function (props) {
  var className = props.className,
    ...
    _a2 = props.hidePopper,
    hidePopper = _a2 === void 0 ? true : _a2,
  ...
  if (!hidePopper) {
    ...
    popper = import_react3.default.createElement(
      ...
      import_react3.default.createElement(
        ...
        popperComponent,
        showArrow &&
          import_react3.default.createElement(FloatingArrow, {
  ...
  if (props.popperContainer) {
    popper = (0, import_react3.createElement)(
      props.popperContainer,
      {},
      popper,
    );
  }
...
var DatePicker = (function (_super) {
  ...
  function DatePicker2(props) {
    ...
    _this.modifyHolidays = function () {
      var _a2;
      return (_a2 = _this.props.holidays) === null || _a2 === void 0
        ? void 0
        : _a2.reduce(function (accumulator, holiday) {
    ...
    _this.calcInitialState = function () {
      ...
      return {
        ...
        inputValue: null,
        preSelection:
          (_a2 = _this.props.selectsRange
            ? _this.props.startDate
            : _this.props.selected) !== null && _a2 !== void 0
            ? _a2
            : boundedPreSelection,
    ...
    _this.getInputValue = function () {
      ...
      var _b = _this.props,
        ...
        value = _b.value;
      var dateFormat =
        (_a2 = _this.props.dateFormat) !== null && _a2 !== void 0
          ? _a2
          : DatePicker2.defaultProps.dateFormat;
    ...
    _this.setFocus = function () {
      var _a2, _b;
      (_b =
        (_a2 = _this.input) === null || _a2 === void 0 ? void 0 : _a2.focus) ===
        null || _b === void 0
        ? void 0
        : _b.call(_a2, { preventScroll: true });
    };
    ...
    _this.isCalendarOpen = function () {
      return _this.props.open === void 0
    ...
    _this.handleFocus = function (event) {
      ...
      if (!_this.state.preventFocus) {
        (_b = (_a2 = _this.props).onFocus) === null || _b === void 0
          ? void 0
          : _b.call(_a2, event);
        if (
          isOpenAllowed &&
    ...
    _this.handleBlur = function (event) {
      ...
      if (
        ...
        (_b = (_a2 = _this.props).onBlur) === null || _b === void 0
          ? void 0
          : _b.call(_a2, event);
      }
    ...
    _this.handleCalendarClickOutside = function (event) {
      ...
      (_b = (_a2 = _this.props).onClickOutside) === null || _b === void 0
        ? void 0
        : _b.call(_a2, event);
    ...
    _this.handleChange = function () {
      ...
      var strictParsing =
        (_b = _this.props.strictParsing) !== null && _b !== void 0
          ? _b
          : DatePicker2.defaultProps.strictParsing;
      var value =
      ...
      if (selectsRange) {
        ...
        var date = parseDate2(
          ...
          _this.props.locale,
          strictParsing,
          (_e = _this.props.selected) !== null && _e !== void 0 ? _e : void 0,
        );
        if (date || !value) {
    ...
    _this.setSelected = function (date, event, keepInput, monthSelectedIn) {
      ...
      if (
        !isEqual2(_this.props.selected, changedDate) ||
      ...
      if (date) {
        ...
        if (hasMinDate && hasMaxDate) {
          ...
          isValidDateSelection =
            ...
            isEqual2(dateStartOfDay, minDateStartOfDay);
        } else if (hasMaxDate) {
          var maxDateEndOfDay = getEndOfDay(_this.props.maxDate);
          isValidDateSelection =
            isBefore(date, maxDateEndOfDay) ||
            isEqual2(dateStartOfDay, maxDateEndOfDay);
        }
      }
    ...
    _this.onInputClick = function () {
      ...
      (_b = (_a2 = _this.props).onInputClick) === null || _b === void 0
        ? void 0
        : _b.call(_a2);
    };
    _this.onInputKeyDown = function (event) {
      var _a2, _b, _c, _d, _e, _f;
      (_b = (_a2 = _this.props).onKeyDown) === null || _b === void 0
        ? void 0
        : _b.call(_a2, event);
      var eventKey = event.key;
      if (
      ...
      var getNewDate = function (eventKey2, date) {
        ...
        while (!validDateFound) {
          ...
          if (minDate && newSelection2 < minDate) {
            eventKeyCopy = KeyType.ArrowRight;
            newSelection2 = isDayDisabled(minDate, _this.props)
              ? calculateNewDate(eventKeyCopy, newSelection2)
              : minDate;
          }
          if (maxDate && newSelection2 > maxDate) {
            eventKeyCopy = KeyType.ArrowLeft;
            newSelection2 = isDayDisabled(maxDate, _this.props)
              ? calculateNewDate(eventKeyCopy, newSelection2)
              : maxDate;
          }
      ...
      return import_react3.default.createElement(
        ...
        _assign(
          ...
          _this.state,
          {
            ...
            dateFormat:
              (_a2 = _this.props.dateFormatCalendar) !== null && _a2 !== void 0
                ? _a2
                : DatePicker2.defaultProps.dateFormatCalendar,
            ...
            dropdownMode:
              (_b = _this.props.dropdownMode) !== null && _b !== void 0
                ? _b
                : DatePicker2.defaultProps.dropdownMode,
          },
        ),
        _this.props.children,
      );
      ...
      if (_this.props.selectsRange) {
        ...
        if (_this.props.showTimeSelectOnly) {
          ariaLiveMessage = "Selected time: ".concat(
            safeDateFormat(_this.props.selected, { dateFormat, locale }),
          );
      ...
      var className = clsx(
        ...
        (_a2[
          _this.props.outsideClickIgnoreClass ||
            DatePicker2.defaultProps.outsideClickIgnoreClass
        ] = _this.state.open),
        _a2),
      );
      var customInput =
        _this.props.customInput ||
        import_react3.default.createElement("input", { type: "text" });
    ...
    _this.renderClearButton = function () {
      var _a2 = _this.props,
        isClearable = _a2.isClearable,
        disabled = _a2.disabled,
        selected = _a2.selected,
        startDate = _a2.startDate,
        endDate = _a2.endDate,
        clearButtonTitle = _a2.clearButtonTitle,
        _b = _a2.clearButtonClassName,
        clearButtonClassName = _b === void 0 ? "" : _b,
        _c = _a2.ariaLabelClose,
  ...
  DatePicker2.prototype.componentDidUpdate = function (prevProps, prevState) {
    ...
    if (
      !prevState.focused &&
      !isEqual2(prevProps.selected, this.props.selected)
    ) {
      this.setState({ inputValue: null });
    }
    if (prevState.open !== this.state.open) {
      if (prevState.open === false && this.state.open === true) {
        (_b = (_a2 = this.props).onCalendarOpen) === null || _b === void 0
          ? void 0
          : _b.call(_a2);
      }
  ...
  DatePicker2.prototype.renderInputContainer = function () {
    var _a2 = this.props,
      showIcon = _a2.showIcon,
      icon = _a2.icon,
      calendarIconClassname = _a2.calendarIconClassname,
      calendarIconClassName = _a2.calendarIconClassName,
      toggleCalendarOnIconClick = _a2.toggleCalendarOnIconClick;
  ...
  DatePicker2.prototype.render = function () {
    ...
    if (this.props.withPortal) {
      ...
      if (this.state.open && this.props.portalId) {
        portalContainer = import_react3.default.createElement(
          Portal,
