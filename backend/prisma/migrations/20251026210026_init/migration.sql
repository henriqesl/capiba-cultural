...
CREATE TABLE "eventos" (
    ...
    "pequenoPorte" BOOLEAN NOT NULL DEFAULT true,
    "moedasCapibasDestribuidas" DOUBLE PRECISION NOT NULL DEFAULT 0,
    "reportadoPorUsuario" BOOLEAN NOT NULL DEFAULT false,
...
CREATE TABLE "caravanas" (
    ...
    "descricao" TEXT NOT NULL,
    "ativo" BOOLEAN NOT NULL DEFAULT true,
    "bonusPorParticipante" INTEGER NOT NULL DEFAULT 10,
...
CREATE TABLE "_ParticipantesDoEvento" (
    ...
    CONSTRAINT "_ParticipantesDoEvento_AB_pkey" PRIMARY KEY ("A","B")
);
...
-- AddForeignKey
ALTER TABLE "caravanas" ADD CONSTRAINT "caravanas_eventoId_fkey" FOREIGN KEY ("eventoId") REFERENCES "eventos"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
